...
public class FreeBoardVO {
	private int    boNo;		/*글 번호 (자동 증가)*/
	private String boTitle ;    /*글 제목*/
	private String boCategory ; /*글 분류 코드*/
	private String boCategoryNm ; /*글 분류 코드*/
	...
	private String boRegDate ;  /*등록 일자 (기본값: 현재 시간)*/
	...
	public String toString() {
		return "FreeBoardVO [boNo=" + boNo + ", boTitle=" + boTitle + ", boCategoryNm=" + boCategoryNm + ", boWriter="
