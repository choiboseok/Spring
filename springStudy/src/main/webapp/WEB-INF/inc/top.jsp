...
<nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="#page-top">스프링 프레임워크MVC 프로젝트</a>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <c:if test="${sessionScope.login != null}">
                	<c:if test="${sessionScope.login.memId eq 'admin' }">
		                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="${pageContext.request.contextPath}/admin">메일전송</a></li>
                	</c:if>
	                ...
	                <a class="nav-link py-3 px-0 px-lg-3 rounded" href="${pageContext.request.contextPath}/mypage">${sessionScope.login.memId}님(마이페이지)</a></li>
	                <li class="nav-item mx-0 mx-lg-1">
	                <c:if test="${sessionScope.login.profileImg == null}">
	                	<img src="${pageContext.request.contextPath}/assets/img/non.png" class="rounded-circle img-thumbnail shadow-sm" width="50">
                	</c:if>
                	<c:if test="${sessionScope.login.profileImg != null }">
	                	<img src="${pageContext.request.contextPath}${sessionScope.login.profileImg}" class="rounded-circle img-thumbnail shadow-sm" width="50" >
                	</c:if>
	                </li>
