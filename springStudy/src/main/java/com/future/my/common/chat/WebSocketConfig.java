...
@EnableWebSocketMessageBroker // websocket 활성화 STOMP 프로토콜 주고받을 수 있도록
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	@Autowired
	public SimpMessagingTemplate messagingTemp;

	@Override
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		// 처음 접속시 websocket과 연결 할 수 있는 포인트를 지정
	...
	public void configureMessageBroker(MessageBrokerRegistry registry) {
		// subscribe 메세지 라우팅 메세지가 어떻게 라우팅 될지(경로 매핑)
	...
	public void handleWebSocketConnectListener(SessionConnectEvent event) {
		...
		message.put("message", userId + "님이 입장했습니다.");
