					...
					<div class="col-auto col-sm-5 mb-3">
						<form name="search" action="<c:url value='/free/freeList'/>" method="post">
							...
							<div class="input-group">
								...
								<div class="col-sm-6">
									<!-- 검색바 -->
									<input class="form-control shadow-none search" value="${searchVO.searchWord }" name="searchWord" type="search" placeholder="검색어" aria-label="search" value="" />
								</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		// 페이징 처리 관련 태그의 a 태그 클릭이벤트 발생시 해당 패이지로
		$("ul.pagination li a[data-page]").click(function(e){
			// 디폴트 이벤트 종료
			e.preventDefault();
			$("#curPage").val($(this).data("page")); // data-page 속성의 값으로 할당
